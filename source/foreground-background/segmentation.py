...
class Segmentation(object):
    def __init__(self, image_name, image, plot_during_training=True,
        ...
        self.learning_curve = []
        self.psnr_learning_curve = []
        self.early_stop_psnr = early_stop_psnr
        self._init_all()
    ...
    def _finalize_iteration(self):
        ...
        if self.current_psnr > self.early_stop_psnr:
            self.second_step_done = True
        
        self.psnr_learning_curve.append(self.current_psnr)

    def _iteration_plot_closure(self, iter_number):
        self.learning_curve.append(self.total_loss.item())
